    ...
    <article className="w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="relative px-6">
        <div className="-mt-14 h-28 w-28 overflow-hidden rounded-full border-4 border-white bg-slate-100 shadow-lg">
          <img
            src={image || `https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(name)}`}
            alt={`${name} profile`}
      ...
      <div className="px-6 pb-6 pt-4">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm font-medium text-indigo-600">{course}</p>
          </div>
          <span className="rounded-lg bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-500">
            STU-{String(id).slice(-3).padStart(3, "0")}
          </span>
        </div>
        ...
        <div className="mt-6 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-700">{age} years</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-indigo-50 text-indigo-600">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor" className="h-5 w-5">
                ...
                <rect width="18" height="13.5" x="3" y="5.25" rx="2" />
              </svg>
            </div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-indigo-50 text-indigo-600">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor" className="h-5 w-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 21s7-5.686 7-12a7 7 0 1 0-14 0c0 6.314 7 12 7 12Z" />
        ...
        <div>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-semibold text-slate-900">Academic Rating</p>
              <p className="mt-1 text-xs text-slate-500">Overall academic performance</p>
            </div>
            <div className="flex items-center gap-1.5">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-amber-400">
                <path fillRule="evenodd" d="M10.788 3.21c.448-1.312 2.306-1.312 2.754 0l.569 1.664a2.75 2.75 0 0 0 2.61 1.856h1.759c1.386 0 1.963 1.777.841 2.601l-1.423 1.035a2.75 2.75 0 0 0-.999 3.077l.546 1.686c.444 1.372-1.13 2.507-2.237 1.686l-1.48-1.068a2.75 2.75 0 0 0-3.254 0l-1.48 1.068c-1.107.821-2.681-.314-2.237-1.686l.546-1.686a2.75 2.75 0 0 0-.999-3.077L4.5 9.331c-1.122-.824-.545-2.601.841-2.601H7.1a2.75 2.75 0 0 0 2.61-1.856l.569-1.664Z" clipRule="evenodd" />
              </svg>
              <span className="text-lg font-bold text-slate-900">{Number(academicRating).toFixed(1)}</span>
          ...
          <div className="mt-3">
            <div className="h-2 overflow-hidden rounded-full bg-slate-100">
              <div
                ...
                style={{ width: `${(Number(academicRating) / 5) * 100}%` }}
              ></div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="rounded-xl bg-red-50 px-4 py-2.5 text-sm font-semibold text-red-600 shadow-sm transition hover:bg-red-100 active:scale-[0.98]"
          >
            Remove
          </button>
        </div>
